...
export const portfolioContent = {
  ...
  projects: [
    ...
    },
    {
      ...
      year: `2023`,
      description: `Récit authentique d'un menuisier spécialisé dans la restauration du patrimoine.`,
      categories: {
        category: `entreprises`,
        client: `institution`,
        type: `mediation`,
      },
      gradient: `linear-gradient(135deg, #d4af37 0%, #e8924f 100%)`,
    },
    {
      id: `doue-en-anjou`,
      tag: `Vœux du Maire`,
      ...
      year: `2022`,
      description: `Célébration du patrimoine et de la vie culturelle où passé et présent coexistent.`,
      categories: {
        category: `institutions`,
        client: `institution`,
        type: `brand`,
      },
      gradient: `linear-gradient(135deg, #b8441e 0%, #7d2e2e 100%)`,
    },
    {
      id: `brissac`,
      tag: `Déambulation`,
      ...
      year: `2023`,
      description: `Continuation du Don Quichotte : le chevalier arrive en Anjou pour investir dans le vignoble.`,
      categories: {
        category: `spectacles`,
        client: `institution`,
        type: `immersive`,
      },
      gradient: `linear-gradient(135deg, #7d2e2e 0%, #2d2d2d 100%)`,
    },
    {
      id: `agglobus`,
      tag: `Prévention`,
      ...
      year: `2023`,
      description: `Texte de prévention narrant l'histoire de deux collégiens, symbole de lien social.`,
      categories: {
        category: `institutions`,
        client: `institution`,
        type: `mediation`,
    ...
    },
    {
      ...
      year: `2022-2023`,
      description: `Deux spectacles musicaux : ALD et intimité des aînés. Bandes-son scéniques avec collectage.`,
      categories: {
        category: `spectacles`,
        client: `spectacle`,
        type: `mediation`,
      },
      gradient: `linear-gradient(135deg, #2d2d2d 0%, #b8441e 100%)`,
    },
  ],
};
